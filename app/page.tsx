  ...
  return (
    <main className="min-h-screen flex flex-col">
      ...
      <header className="flex items-center justify-between px-6 py-4 max-w-7xl mx-auto w-full">
        ...
        />
        <a
          href="https://wa.me/917303750839?text=Hello%2C%20I%27d%20like%20a%20repair%20quote"
          target="_blank"
      ...
      <section className="flex-1 flex flex-col items-center justify-center text-center px-4 py-20">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <a
            href="https://wa.me/917303750839?text=I%27d%20like%20a%20free%20quote"
            target="_blank"
            rel="noopener noreferrer"
      ...
      <footer className="bg-neutral-50 py-12 px-4 border-t border-neutral-100">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between text-sm text-neutral-500 gap-4">
          <div className="flex gap-6">
            <a href="tel:+917303750839" className="hover:text-amber-800">📞 +91 7303750839</a>
      ...
      <a
        href="https://wa.me/917303750839?text=Hello%2C%20I%27d%20like%20to%20know%20more%20about%20your%20services"
        target="_blank"
        rel="noopener noreferrer"
